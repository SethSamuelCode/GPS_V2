...
void setup()
{
  ...
  // myGNSS.setNavigationFrequency(50); // Produce two solutions per second
  myGNSS.setMeasurementRate(1);
...
void loop()
{
  ...
  if (myGNSS.getPVT() == true)
  {
    ...
    int32_t speedMs = myGNSS.getGroundSpeed();
    output += F("Speed: ");
    output += speedMs*3.6;
    
    int32_t time = myGNSS.getSecond();
